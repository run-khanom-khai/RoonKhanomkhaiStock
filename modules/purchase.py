...
def render():
    ...
    tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs([
        "📦 บันทึกการซื้อวัตถุดิบเข้า",
        "🚛 เบิกของเข้าสาขา",
        "📊 Stock คงเหลือ",
        "📋 ประวัติ Movement",
        "🏢 การซื้อทรัพย์สินเข้า",
        "🛠️ การซ่อมแซมทรัพย์สิน",
    ])
    with tab1:
    ...
    with tab5:
        from modules.asset_management import render_asset_purchase
        render_asset_purchase()
    with tab6:
        from modules.asset_management import render_asset_repair
        render_asset_repair()
