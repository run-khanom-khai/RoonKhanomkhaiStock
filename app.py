...
try:
    ...
    err_msg = str(e).lower()
    if "zip file" in err_msg or "not a zip" in err_msg or "badzip" in err_msg:
        # ไฟล์ Excel เสียหาย — ลบทิ้งแล้วสร้างใหม่ (ใช้ Local mode เท่านั้น)
        try:
            import os as _os
            ...
            # ถ้ายังไม่ได้ก็ข้ามไป — บน Cloud ใช้ Google Sheets ไม่ต้องการ Excel
            pass
    else:
